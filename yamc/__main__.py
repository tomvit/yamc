...
# input arguments
parser = argparse.ArgumentParser(prog="yamc", description='Yet another metric collector', add_help=True)
...
optional.add_argument('--env', required=False, default=None, help='Environment variables file', metavar='<file>')
...
optional.add_argument('--show-config', required=False, default=False, help='Show consolidated configurarion before validation', action='store_true')
...
logarg.add_argument('--trace', required=False, default=False, action='store_true', help='Print even more details in the log')
